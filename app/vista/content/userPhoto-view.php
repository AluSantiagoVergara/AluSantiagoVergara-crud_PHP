	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<figure class="image mb-6">
                <img class="is-rounded" src="<?php echo APP_URL; ?>app/vista/fotos/<?php echo $datos['usuario_foto']; ?>">
			</figure>
			...
			<?php }else{ ?>
			<figure class="image mb-6">
			  	<img class="is-rounded" src="<?php echo APP_URL; ?>app/vista/fotos/default.png">
			</figure>
			<?php }?>
		</div>
